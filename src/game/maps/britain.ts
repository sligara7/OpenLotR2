...
const regions: MapRegion[] = [
  ...
  r('clackmannanshire', 'Clackmannanshire', 'Scotland', 6, 6, ['fife', 'perthshire', 'stirlingshire']),
  ...
  r('middlesex', 'Middlesex', 'England', 8, 18, ['hertfordshire', 'buckinghamshire', 'essex', 'surrey', 'kent']),
